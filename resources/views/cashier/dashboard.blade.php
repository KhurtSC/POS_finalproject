                ...
                <div class="grid gap-3 lg:grid-cols-[1.2fr_1fr_220px]">
                    <label class="relative block">
                        ...
                        <input data-code-scan placeholder="Scan QR/barcode or type SKU"
                            class="w-full rounded-md border border-slate-300 py-3 pl-16 pr-4 text-sm font-bold outline-none transition focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10">
                    </label>
        ...
        <div class="w-full max-w-md rounded-xl bg-white shadow-xl">
            ...
            <div class="space-y-4 px-6 py-5">
                <div class="rounded-lg bg-slate-50 px-4 py-3 text-sm">
                    <div class="flex justify-between text-slate-500"><span>Subtotal</span><span data-modal-subtotal>PHP 0.00</span></div>
                    <div data-discount-row class="hidden flex justify-between text-red-600"><span>Discount</span><span data-modal-discount>-PHP 0.00</span></div>
                    <div class="mt-2 flex justify-between border-t border-slate-200 pt-2 text-base font-black text-slate-950"><span>Total</span><span data-modal-total>PHP 0.00</span></div>
                </div>
                ...
                <div data-cash-section>
                    ...
                    <div class="mt-2 flex justify-between rounded-lg bg-teal-50 px-4 py-2 text-sm font-black text-teal-700">
                        <span>Change</span>
                        <span data-change-display>PHP 0.00</span>
                    </div>
                </div>
            </div>
